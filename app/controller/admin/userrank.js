...
class UserrankController extends BaseController{
    ...
    async list()
    {
        ...
        {
          await this.fail('/admin/userrank','角色列表数据出错')
    ...
    async edit()
    {
      ...
      console.log(result.flag);
        ...
        {
          await this.fail('/admin/userrank','访问异常')
    ...
    async doEdit()
    {
      ...
      if(result)
      {
          await this.success('/admin/userrank','修改成功')
      }

      else
      {
        await this.fail('/admin/userrank/edit','访问异常')
